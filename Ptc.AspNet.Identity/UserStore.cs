...
namespace Ptc.AspNet.Identity
{
    ...
    public class CCEngUserStore<TUser> : UserStore<TUser, IdentityRole, string, IdentityUserLogin, IdentityUserRole, IdentityUserClaim>, IUserStore<TUser>, IUserStore<TUser, string>, IDisposable where TUser : IdentityUser
    {
        ...
        public new IQueryable<TUser> Users
        {
            get
            {
        ...
        /// </summary>
        public CCEngUserStore(DbContext context) : base(context)
        {
            //new UserStore<TUser>(new DataBase.EsunEntities());
            var database = new SetengUser();
        ...
        /// </summary>
        /// <param name="compUser">The user's name</param>
        /// <returns></returns>
        public override Task<TUser> FindByNameAsync(string compUser)
        {

            if (string.IsNullOrEmpty(compUser))
                throw new ArgumentException("Null or empty argument: userName");


            var user = JsonConvert.DeserializeObject<UserBase>(compUser);


            List<TUser> result = userTable.GetUserByName(user.CompCd, user.UserId);
        ...
        /// <returns></returns>
        public override Task RemoveClaimAsync(TUser user, Claim claim)
        {
            if (user == null)
            {
                throw new ArgumentNullException("user");
        ...
        /// <returns></returns>
        public override Task RemoveLoginAsync(TUser user, UserLoginInfo login)
        {
            if (user == null)
            {
                throw new ArgumentNullException("user");
        ...
        /// <param name="role"></param>
        /// <returns></returns>
        public override Task RemoveFromRoleAsync(TUser user, string role)
        {
            throw new NotImplementedException();
        }
        ...
        /// <returns></returns>
        public override Task SetPasswordHashAsync(TUser user, string passwordHash)
        {
