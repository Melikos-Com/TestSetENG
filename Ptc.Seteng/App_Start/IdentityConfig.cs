...
namespace Ptc.Seteng
{
    ...
    public class ApplicationUserManager : UserManager<IdentityUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new CCEngUserStore<IdentityUser>(context.Get<AspNet.Identity.database.SetengUser>()));
            ...
            ////取消密碼hash
            manager.PasswordHasher = new Identity.ClearPassword();
