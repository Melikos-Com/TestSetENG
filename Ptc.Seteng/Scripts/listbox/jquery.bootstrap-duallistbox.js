;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: '選項: {0} 筆',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">選項:</span> {0} 筆', // when not all of the options are visible due to the filter
      infoTextEmpty: '目前沒有項目',                                                        // when there are no options present in the list
  ...
  BootstrapDualListbox.prototype = {
    ...
    setMoveAllLabel: function(value, refresh) {
      ...
      this.elements.moveAllButton.attr('name', 'movebtn');
      if (refresh) {
        refreshSelects(this);
      }
      return this.element;
    ...
    setRemoveAllLabel: function(value, refresh) {
      ...
      this.elements.removeAllButton.attr('name', 'movebtn');
      if (refresh) {
        refreshSelects(this);
      }
      return this.element;
