...
import { PtcDetailAction } from './ptc-detail-action';
...
@Component({
    selector: 'ptc-detail',
    templateUrl: 'ptc-detail.html'
})
export class PtcDetail {
    ...
    slideChanged() {
        ...
        this.slides.lockSwipeToNext((currentIndex == 2));
    ...
    */
    venderConfirm() {
        ...
        if (detail.FcDate == null) {
            this.showToast("請點擊離店時間", false);
            return;
        };
    ...
    SetLeaveDate() {
        ...
        if (detail.FcDate == null) {
            ...
            if (Sec.length == 1)
                Sec = "0" + Sec;
            detail.FcDate = Year + "/" + strMonth + "/" + day + " " + hour + ":" + Min + ":" + Sec
        }
    };
}
